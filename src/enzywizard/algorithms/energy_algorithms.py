...
def compute_energy_terms(struct: PDBFile | PDBxFile, logger: Logger, minimize_energy: bool = True, minimization_iteration:int = 2000,force_field_file="charmm36.xml") -> Dict[str, float] | None:
