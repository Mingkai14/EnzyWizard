...
def run_mutclean_service(wt_input_path: str | Path, mut_input_path: str | Path, mutation:str, output_dir: str | Path, add_H: bool = True, pH: float = 7.0, force_field_file: str = "charmm36.xml")->bool:
    ...
    cleaned_wt_cif_path = output_dir / f"cleaned_{wt_name}.cif"
    cleaned_wt_pdb_path = output_dir / f"cleaned_{wt_name}.pdb"
    cleaned_wt_fasta_path = output_dir / f"cleaned_{wt_name}.fasta"

    cleaned_mut_cif_path = output_dir / f"cleaned_{mut_name}.cif"
